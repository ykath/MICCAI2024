#!/usr/bin/env python3
"""Local browser/API for the MICCAI 2024 SQLite database."""
                    ...
                    if keywords:
                        ...
                        for kw in keywords:
                            sub = (
                                ...
                                "OR meta_review LIKE ? OR meta_review_zh LIKE ? OR reviews_text LIKE ? "
                                "OR reviews_text_zh LIKE ? OR categories LIKE ?)"
                            )
                            like = f"%{kw}%"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Browse MICCAI 2024 SQLite database.")
    ...
    print(f"MICCAI 2024 browser running at {url}")
    if not args.no_open:
        webbrowser.open(url)
